...
Este proyecto es **UWP con .NET moderno** (`.csproj` SDK-style, `UseUwp`, `net10.0-windows10.0.26100.0`). Los widgets de Xbox Game Bar **deben** seguir siendo UWP; no es un proyecto WinUI 3 / Windows App SDK independiente. Funciona en **Windows 10 y Windows 11** con Visual Studio 2022 o 2026.
